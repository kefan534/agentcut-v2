                                ...
                                <section className="rounded-lg border border-stone-200 p-3 dark:border-stone-800">
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2">
                                        ...
                                        <Form.Item label="远程目录" extra={`会在该目录下分业务目录保存，每个目录包含 ${WEBDAV_MANIFEST_FILE_NAME} 和 files/`} className="mb-4">
                                            <Input value={webdav.directory} placeholder="agentcut" onChange={(event) => updateWebdavConfig("directory", event.target.value)} />
                                        </Form.Item>
        ...
        <Modal
            title={
                <div>
                    ...
                    <div className="mt-1 text-xs font-normal text-stone-500">默认模型、生成参数和同步偏好</div>
                </div>
            }
            open={isConfigOpen}
            width={980}
